	...
	private String content; -->
        ...
        <tr>
           ...
           <td>
              ...
              <a class="button border-main" href="${ctx}/xl/update.do?id=${data.id}"><span class="icon-edit"></span>修改</a> 
      ...
      <tr>
        ...
        <!-- 分页开始 -->
			      <pg:pager  url="${ctx}/xl/findByObj.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
					<pg:last>  
...
function del(id){
	if(confirm("您确定要删除吗?")){
		window.location.href="${ctx}/xl/delete.do?id="+id;
	}
}
function DelSelect(){
	var Checkbox=false;
