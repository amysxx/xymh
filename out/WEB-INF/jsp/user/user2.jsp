...
<body>
<form method="post" action="${ctx}/user/findByMap.do?type=2" id="listform">
      ...
      <tr>
        ...
        <tr>
           ...
           <td>
              ...
              <a class="button border-main" href="${ctx}/user/update.do?type=2&id=${data.id}"><span class="icon-edit"></span>修改</a> 
