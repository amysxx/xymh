...
<!-- model.addAttribute("phs", phs);
		...
		<div class="banner">
			...
			<ul>
			 <c:forEach items="${phs}" var="data" varStatus="l">
			    <li><a><img src="${data.content}"  style="height: 280px;width: 1100px;"/></a></li>
             </c:forEach>
			</ul>
		</div><!--focus end-->
		</div>
		...
		<div class="notice_wrap">
			<div class="notice">
				...
				<a href="${ctx}/notice/findByObj2.do" class="more fr">更多+</a>
				<div class="clear"></div>
			</div>
		</div>
		<!--content start-->
		<div class="content">
			...
			<div class="box1">
				<div class="fl">
					<div class="news">
						<div class="b_title">
							<h3>新闻快讯</h3>
							<a href="${ctx}/news/findByObj2.do" class="more">更多+</a>
						</div>
						<div class="b_wrap">
							<div class="fl n_list">
								<ul>
				...
				<div class="fl">
					<div class="news" style="margin-left: 30px">
						<div class="b_title">
							<h3>校园招聘</h3>
							<a href="${ctx}/schoolJob/findByObj2.do" class="more">更多+</a>
						</div>
						<div class="b_wrap">
							<div class="fl n_list">
								<ul>
			...
			<div class="fl">
					<div class="news" style="height: 250px;margin-top: 0px">
						<div class="b_title">
							<h3>通知公告</h3>
							<a href="${ctx}/notice/findByObj2.do" class="more">更多+</a>
						</div>
						<div class="b_wrap">
							<div class="fl n_list">
								<ul>
				...
				<div class="exam fr">
					<div class="b_title">
						<h3>校历</h3>
						<a href="${ctx}/xl/findByObj2.do" class="more">更多+</a>
					</div>
					<div class="b_wrap">
						<div class="n_list">
							<ul>
