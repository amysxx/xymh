...
<body>
<form method="post" action="${ctx}/user/findByMap.do?type=1" id="listform">
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <tr>
           ...
           <td>
              ...
              <a class="button border-main" href="${ctx}/user/update.do?type=1&id=${data.id}"><span class="icon-edit"></span>修改</a> 
               <a class="button border-main" href="${ctx}/user/jsFp.do?id=${data.id}"><span class="icon-edit"></span>角色分配</a>
      ...
      <tr>
        ...
        <!-- 分页开始 -->
			      <pg:pager  url="${ctx}/user/findByMap.do" maxIndexPages="5" items="${pagers.total}"  maxPageItems="15" export="curPage=pageNumber" >
...
function del(id){
	if(confirm("您确定要删除吗?")){
		window.location.href="${ctx}/user/delete.do?id="+id;
	}
}
function DelSelect(){
	var Checkbox=false;
